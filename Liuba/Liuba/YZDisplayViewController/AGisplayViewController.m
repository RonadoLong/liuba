...
#import "AGisplayViewController.h"
#import "AGisplayTitleLabel.h"
#import "AGDisplayViewHeader.h"
#import "UIView+Frame.h"
#import "AGFlowLayout.h"

@interface AGisplayViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation AGisplayViewController
...
- (UIScrollView *)contentScrollView
{
    if (_contentScrollView == nil) {
        ...
        // 创建布局
        AGFlowLayout *layout = [[AGFlowLayout alloc] init];
...
- (void)setIsAGScreen:(BOOL)isAGScreen
{
    _isAGScreen = isAGScreen;
...
- (void)viewDidLayoutSubviews
{
    ...
    CGFloat titleY = _isAGScreen?contentY:0;
    ...
    self.contentScrollView.frame = _isAGScreen?CGRectMake(0, 0, contentW, YZScreenH) :CGRectMake(0, contentScrollY, contentW, self.contentView.height - contentScrollY);
...
- (void)setUpAllTitle
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        UILabel *label = [[AGisplayTitleLabel alloc] init];
...
// 设置标题颜色渐变
- (void)setUpTitleColorGradientWithOffset:(CGFloat)offsetX rightLabel:(AGisplayTitleLabel *)rightLabel leftLabel:(AGisplayTitleLabel *)leftLabel
{
...
- (void)selectLabel:(UILabel *)label
{
    ...
    for (AGisplayTitleLabel *labelView in self.titleLabels) {
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    // 左边按钮
    AGisplayTitleLabel *leftLabel = self.titleLabels[leftIndex];
    
    // 右边角标
    NSInteger rightIndex = leftIndex + 1;
    
    // 右边按钮
    AGisplayTitleLabel *rightLabel = nil;
